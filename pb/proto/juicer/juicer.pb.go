...
func (x *Message) GetDrawDeclined() *DrawDeclined {
	if x != nil {
		if x, ok := x.Event.(*Message_DrawDeclined); ok {
			return x.DrawDeclined
		}
	}
	return nil
}

func (x *Message) GetDrawOffer() *DrawOffer {
	if x != nil {
		if x, ok := x.Event.(*Message_DrawOffer); ok {
			return x.DrawOffer
		}
	}
	return nil
...
func (x *Message) GetGameInfo() *GameInfo {
	if x != nil {
		if x, ok := x.Event.(*Message_GameInfo); ok {
			return x.GameInfo
		}
	}
	return nil
...
type Message_SeekGame struct {
	SeekGame *SeekGame `protobuf:"bytes,16,opt,name=seek_game,json=seekGame,proto3,oneof"`
}

type Message_CancelSeekGame struct {
	CancelSeekGame *CancelSeekGame `protobuf:"bytes,17,opt,name=cancel_seek_game,json=cancelSeekGame,proto3,oneof"`
}

type Message_GameFound struct {
	GameFound *GameFound `protobuf:"bytes,18,opt,name=game_found,json=gameFound,proto3,oneof"`
}

type Message_AbortGame struct {
	AbortGame *AbortGame `protobuf:"bytes,19,opt,name=abort_game,json=abortGame,proto3,oneof"`
}

type Message_ResignGame struct {
	ResignGame *ResignGame `protobuf:"bytes,20,opt,name=resign_game,json=resignGame,proto3,oneof"`
}

type Message_OfferDraw struct {
	OfferDraw *OfferDraw `protobuf:"bytes,21,opt,name=offer_draw,json=offerDraw,proto3,oneof"`
}

type Message_AcceptDraw struct {
	AcceptDraw *AcceptDraw `protobuf:"bytes,22,opt,name=accept_draw,json=acceptDraw,proto3,oneof"`
}

type Message_DeclineDraw struct {
	DeclineDraw *DeclineDraw `protobuf:"bytes,23,opt,name=decline_draw,json=declineDraw,proto3,oneof"`
}
...
type Message_SendGameChat struct {
	SendGameChat *SendGameChat `protobuf:"bytes,27,opt,name=send_game_chat,json=sendGameChat,proto3,oneof"`
}

type Message_ListGameChats struct {
	ListGameChats *ListGameChats `protobuf:"bytes,28,opt,name=list_game_chats,json=listGameChats,proto3,oneof"`
}

type Message_GameChat struct {
	GameChat *GameChat `protobuf:"bytes,29,opt,name=game_chat,json=gameChat,proto3,oneof"`
}
...
type Message_DrawOffer struct {
	DrawOffer *DrawOffer `protobuf:"bytes,65,opt,name=draw_offer,json=drawOffer,proto3,oneof"`
}
...
type Message_GameInfo struct {
	GameInfo *GameInfo `protobuf:"bytes,67,opt,name=game_info,json=gameInfo,proto3,oneof"`
}
...
func (*Message_DrawOffer) isMessage_Event() {}
...
func (x *GameInfo) GetGameTimeKind() GameTimeKind {
	if x != nil {
		return x.GameTimeKind
	}
	return GameTimeKind_GAME_TIME_KIND_UNSPECIFIED
}

func (x *GameInfo) GetGameTimeCategory() GameTimeCategory {
	if x != nil {
		return x.GameTimeCategory
	}
	return GameTimeCategory_GAME_TIME_CATEGORY_UNSPECIFIED
}
...
func (x *GameInfo) GetColor() Color {
	if x != nil {
		return x.Color
	}
...
func (x *GameInfo) GetClocks() *Clocks {
	if x != nil {
		return x.Clocks
	}
	return nil
...
func (x *GameInfo) GetLegalMoves() []string {
	if x != nil {
		return x.LegalMoves
	}
	return nil
...
func (x *GameInfo) GetReconnectTimeoutMs() int32 {
	if x != nil {
...
func (x *GameInfo) GetFirstMoveTimeoutMs() int32 {
	if x != nil {
...
func (x *GameInfo) GetGameMoves() []*GameMove {
	if x != nil {
		return x.GameMoves
	}
	return nil
...
func (x *GameInfo) GetStartTime() *timestamppb.Timestamp {
	if x != nil {
		return x.StartTime
	}
	return nil
...
type DrawOffer struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	GameId        int32                  `protobuf:"varint,1,opt,name=game_id,json=gameId,proto3" json:"game_id,omitempty"`
	Ply           uint32                 `protobuf:"varint,2,opt,name=ply,proto3" json:"ply,omitempty"`
	OfferedBy     string                 `protobuf:"bytes,3,opt,name=offered_by,json=offeredBy,proto3" json:"offered_by,omitempty"`
	OfferedAt     *timestamppb.Timestamp `protobuf:"bytes,4,opt,name=offered_at,json=offeredAt,proto3" json:"offered_at,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *DrawOffer) Reset() {
	*x = DrawOffer{}
...
func (x *DrawOffer) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DrawOffer) ProtoMessage() {}

func (x *DrawOffer) ProtoReflect() protoreflect.Message {
	mi := &file_proto_juicer_juicer_proto_msgTypes[25]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DrawOffer.ProtoReflect.Descriptor instead.
func (*DrawOffer) Descriptor() ([]byte, []int) {
	return file_proto_juicer_juicer_proto_rawDescGZIP(), []int{25}
}

func (x *DrawOffer) GetGameId() int32 {
	if x != nil {
		return x.GameId
	}
	return 0
...
func (x *DrawOffer) GetPly() uint32 {
	if x != nil {
		return x.Ply
	}
	return 0
...
func (x *DrawOffer) GetOfferedBy() string {
	if x != nil {
		return x.OfferedBy
	}
	return ""
...
func (x *DrawOffer) GetOfferedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.OfferedAt
	}
	return nil
...
type DrawDeclined struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	GameId        int32                  `protobuf:"varint,1,opt,name=game_id,json=gameId,proto3" json:"game_id,omitempty"`
	DeclinedBy    string                 `protobuf:"bytes,3,opt,name=declined_by,json=declinedBy,proto3" json:"declined_by,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *DrawDeclined) Reset() {
	*x = DrawDeclined{}
...
func (x *DrawDeclined) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DrawDeclined) ProtoMessage() {}

func (x *DrawDeclined) ProtoReflect() protoreflect.Message {
	mi := &file_proto_juicer_juicer_proto_msgTypes[26]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DrawDeclined.ProtoReflect.Descriptor instead.
func (*DrawDeclined) Descriptor() ([]byte, []int) {
	return file_proto_juicer_juicer_proto_rawDescGZIP(), []int{26}
}

func (x *DrawDeclined) GetGameId() int32 {
	if x != nil {
		return x.GameId
	}
	return 0
...
func (x *DrawDeclined) GetDeclinedBy() string {
	if x != nil {
		return x.DeclinedBy
	}
	return ""
...
func (x *ListLobbyChats) GetCursor() string {
...
func (x *ListLobbyChats) GetPageSize() int32 {
...
type LobbyChat struct {
	...
	User          *ChatUserSnapshot      `protobuf:"bytes,3,opt,name=user,proto3" json:"user,omitempty"`
...
func (x *LobbyChat) GetUser() *ChatUserSnapshot {
	if x != nil {
		return x.User
	}
	return nil
...
func (x *LobbyChat) GetPostedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.PostedAt
	}
	return nil
...
func (x *LobbyChatList) GetHasMore() bool {
	if x != nil {
		return x.HasMore
	}
	return false
...
func (x *ListGameChats) GetCursor() string {
	if x != nil && x.Cursor != nil {
		return *x.Cursor
	}
	return ""
...
func (x *ListGameChats) GetPageSize() int32 {
	if x != nil && x.PageSize != nil {
		return *x.PageSize
	}
	return 0
...
func (x *ChatUserSnapshot) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ChatUserSnapshot) ProtoMessage() {}

func (x *ChatUserSnapshot) ProtoReflect() protoreflect.Message {
	mi := &file_proto_juicer_juicer_proto_msgTypes[35]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ChatUserSnapshot.ProtoReflect.Descriptor instead.
func (*ChatUserSnapshot) Descriptor() ([]byte, []int) {
	return file_proto_juicer_juicer_proto_rawDescGZIP(), []int{35}
}

func (x *ChatUserSnapshot) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *ChatUserSnapshot) GetUsername() string {
	if x != nil {
		return x.Username
	}
	return ""
...
type GameChat struct {
	...
	User          *ChatUserSnapshot      `protobuf:"bytes,4,opt,name=user,proto3" json:"user,omitempty"`
...
func (x *GameChat) GetUser() *ChatUserSnapshot {
	if x != nil {
		return x.User
	}
	return nil
...
func (x *GameChat) GetPostedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.PostedAt
	}
	return nil
...
type GameChatList struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	GameId        int32                  `protobuf:"varint,1,opt,name=game_id,json=gameId,proto3" json:"game_id,omitempty"`
	GameChats     []*GameChat            `protobuf:"bytes,2,rep,name=game_chats,json=gameChats,proto3" json:"game_chats,omitempty"`
...
func (x *GameChatList) GetGameId() int32 {
	if x != nil {
		return x.GameId
	}
	return 0
...
func (x *GameChatList) GetHasMore() bool {
	if x != nil {
		return x.HasMore
	}
	return false
...
func (x *MoveAck) Reset() {
	*x = MoveAck{}
	mi := &file_proto_juicer_juicer_proto_msgTypes[39]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MoveAck) Descriptor() ([]byte, []int) {
	return file_proto_juicer_juicer_proto_rawDescGZIP(), []int{39}
}
...
func (x *MoveSync) Reset() {
	*x = MoveSync{}
	mi := &file_proto_juicer_juicer_proto_msgTypes[40]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MoveSync) Descriptor() ([]byte, []int) {
	return file_proto_juicer_juicer_proto_rawDescGZIP(), []int{40}
}
...
func (x *PlayerRejoined) Reset() {
	*x = PlayerRejoined{}
	mi := &file_proto_juicer_juicer_proto_msgTypes[43]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PlayerRejoined) Descriptor() ([]byte, []int) {
	return file_proto_juicer_juicer_proto_rawDescGZIP(), []int{43}
}
...
const file_proto_juicer_juicer_proto_rawDesc = "" +
	...
	"lobbyChats\x12+\n" +
	"\tseek_game\x18\x10 \x01(\v2\f.pb.SeekGameH\x00R\bseekGame\x12>\n" +
	"\x10cancel_seek_game\x18\x11 \x01(\v2\x12.pb.CancelSeekGameH\x00R\x0ecancelSeekGame\x12.\n" +
	"\n" +
	"game_found\x18\x12 \x01(\v2\r.pb.GameFoundH\x00R\tgameFound\x12.\n" +
	"\n" +
	"abort_game\x18\x13 \x01(\v2\r.pb.AbortGameH\x00R\tabortGame\x121\n" +
	"\vresign_game\x18\x14 \x01(\v2\x0e.pb.ResignGameH\x00R\n" +
	"resignGame\x12.\n" +
	"\n" +
	"offer_draw\x18\x15 \x01(\v2\r.pb.OfferDrawH\x00R\tofferDraw\x121\n" +
	...
	"\agame_id\x18\x01 \x01(\x05R\x06gameId\"$\n" +
	"\tOfferDraw\x12\x17\n" +
	"\agame_id\x18\x01 \x01(\x05R\x06gameId\"\x90\x01\n" +
	"\tDrawOffer\x12\x17\n" +
	"\agame_id\x18\x01 \x01(\x05R\x06gameId\x12\x10\n" +
	"\x03ply\x18\x02 \x01(\rR\x03ply\x12\x1d\n" +
	"\n" +
	"offered_by\x18\x03 \x01(\tR\tofferedBy\x129\n" +
	"\n" +
	"offered_at\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\tofferedAt\"H\n" +
	"\fDrawDeclined\x12\x17\n" +
	"\agame_id\x18\x01 \x01(\x05R\x06gameId\x12\x1f\n" +
	"\vdeclined_by\x18\x03 \x01(\tR\n" +
	"declinedBy\"&\n" +
	...
	"\x04user\x18\x03 \x01(\v2\x14.pb.ChatUserSnapshotR\x04user\x127\n" +
	"\tposted_at\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\bpostedAt\"Z\n" +
	"\rLobbyChatList\x12.\n" +
	...
	"\n" +
	"_page_size\">\n" +
	"\x10ChatUserSnapshot\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1a\n" +
	"\busername\x18\x02 \x01(\tR\busername\"\xbf\x01\n" +
	"\bGameChat\x12\x17\n" +
	"\agame_id\x18\x01 \x01(\x05R\x06gameId\x12\x1d\n" +
	"\n" +
	"message_id\x18\x02 \x01(\tR\tmessageId\x12\x18\n" +
	"\amessage\x18\x03 \x01(\tR\amessage\x12(\n" +
	"\x04user\x18\x04 \x01(\v2\x14.pb.ChatUserSnapshotR\x04user\x127\n" +
	"\tposted_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\bpostedAt\"o\n" +
	"\fGameChatList\x12\x17\n" +
	"\agame_id\x18\x01 \x01(\x05R\x06gameId\x12+\n" +
	"\n" +
	"game_chats\x18\x02 \x03(\v2\f.pb.GameChatR\tgameChats\x12\x19\n" +
...
var file_proto_juicer_juicer_proto_msgTypes = make([]protoimpl.MessageInfo, 45)
var file_proto_juicer_juicer_proto_goTypes = []any{
	...
	(*AbortGame)(nil),             // 30: pb.AbortGame
	(*ResignGame)(nil),            // 31: pb.ResignGame
	(*OfferDraw)(nil),             // 32: pb.OfferDraw
	(*DrawOffer)(nil),             // 33: pb.DrawOffer
	(*DrawDeclined)(nil),          // 34: pb.DrawDeclined
	(*DeclineDraw)(nil),           // 35: pb.DeclineDraw
	(*AcceptDraw)(nil),            // 36: pb.AcceptDraw
	(*SendLobbyChat)(nil),         // 37: pb.SendLobbyChat
	(*ListLobbyChats)(nil),        // 38: pb.ListLobbyChats
	(*LobbyChat)(nil),             // 39: pb.LobbyChat
	(*LobbyChatList)(nil),         // 40: pb.LobbyChatList
	(*SendGameChat)(nil),          // 41: pb.SendGameChat
	(*ListGameChats)(nil),         // 42: pb.ListGameChats
	(*ChatUserSnapshot)(nil),      // 43: pb.ChatUserSnapshot
	(*GameChat)(nil),              // 44: pb.GameChat
	(*GameChatList)(nil),          // 45: pb.GameChatList
	(*PlayMoveUCI)(nil),           // 46: pb.PlayMoveUCI
	(*MoveAck)(nil),               // 47: pb.MoveAck
	(*MoveSync)(nil),              // 48: pb.MoveSync
	(*GameFinished)(nil),          // 49: pb.GameFinished
	(*PlayerLeft)(nil),            // 50: pb.PlayerLeft
	(*PlayerRejoined)(nil),        // 51: pb.PlayerRejoined
	nil,                           // 52: pb.GameInfo.PendingDrawOffersEntry
...
var file_proto_juicer_juicer_proto_depIdxs = []int32{
	...
	37, // 11: pb.Message.send_lobby_chat:type_name -> pb.SendLobbyChat
	38, // 12: pb.Message.list_lobby_chats:type_name -> pb.ListLobbyChats
	39, // 13: pb.Message.lobby_chat:type_name -> pb.LobbyChat
	40, // 14: pb.Message.lobby_chats:type_name -> pb.LobbyChatList
	24, // 15: pb.Message.seek_game:type_name -> pb.SeekGame
	25, // 16: pb.Message.cancel_seek_game:type_name -> pb.CancelSeekGame
	28, // 17: pb.Message.game_found:type_name -> pb.GameFound
	30, // 18: pb.Message.abort_game:type_name -> pb.AbortGame
	31, // 19: pb.Message.resign_game:type_name -> pb.ResignGame
	32, // 20: pb.Message.offer_draw:type_name -> pb.OfferDraw
	36, // 21: pb.Message.accept_draw:type_name -> pb.AcceptDraw
	35, // 22: pb.Message.decline_draw:type_name -> pb.DeclineDraw
	46, // 23: pb.Message.play_move_uci:type_name -> pb.PlayMoveUCI
	48, // 24: pb.Message.move_sync:type_name -> pb.MoveSync
	49, // 25: pb.Message.game_finished:type_name -> pb.GameFinished
	41, // 26: pb.Message.send_game_chat:type_name -> pb.SendGameChat
	42, // 27: pb.Message.list_game_chats:type_name -> pb.ListGameChats
	44, // 28: pb.Message.game_chat:type_name -> pb.GameChat
	45, // 29: pb.Message.game_chats:type_name -> pb.GameChatList
	50, // 30: pb.Message.player_left:type_name -> pb.PlayerLeft
	51, // 31: pb.Message.player_rejoined:type_name -> pb.PlayerRejoined
	34, // 32: pb.Message.draw_declined:type_name -> pb.DrawDeclined
	33, // 33: pb.Message.draw_offer:type_name -> pb.DrawOffer
	47, // 34: pb.Message.move_ack:type_name -> pb.MoveAck
	...
	53, // 40: pb.Clocks.white:type_name -> google.protobuf.Duration
	53, // 41: pb.Clocks.black:type_name -> google.protobuf.Duration
	8,  // 42: pb.SeekGame.game_time_control:type_name -> pb.GameTimeControl
	54, // 43: pb.GameMove.played_at:type_name -> google.protobuf.Timestamp
	...
	54, // 54: pb.GameInfo.start_time:type_name -> google.protobuf.Timestamp
	54, // 55: pb.GameInfo.end_time:type_name -> google.protobuf.Timestamp
	4,  // 56: pb.GameInfo.game_result:type_name -> pb.GameResult
	5,  // 57: pb.GameInfo.game_result_status:type_name -> pb.GameResultStatus
	54, // 58: pb.GameInfo.last_move:type_name -> google.protobuf.Timestamp
	52, // 59: pb.GameInfo.pending_draw_offers:type_name -> pb.GameInfo.PendingDrawOffersEntry
	54, // 60: pb.GameInfo.white_disconnected_at:type_name -> google.protobuf.Timestamp
	54, // 61: pb.GameInfo.black_disconnected_at:type_name -> google.protobuf.Timestamp
	54, // 62: pb.DrawOffer.offered_at:type_name -> google.protobuf.Timestamp
	43, // 63: pb.LobbyChat.user:type_name -> pb.ChatUserSnapshot
	54, // 64: pb.LobbyChat.posted_at:type_name -> google.protobuf.Timestamp
	39, // 65: pb.LobbyChatList.lobby_chats:type_name -> pb.LobbyChat
	43, // 66: pb.GameChat.user:type_name -> pb.ChatUserSnapshot
	54, // 67: pb.GameChat.posted_at:type_name -> google.protobuf.Timestamp
	44, // 68: pb.GameChatList.game_chats:type_name -> pb.GameChat
	23, // 69: pb.MoveSync.clocks:type_name -> pb.Clocks
	54, // 70: pb.MoveSync.played_at:type_name -> google.protobuf.Timestamp
	4,  // 71: pb.GameFinished.game_result:type_name -> pb.GameResult
	5,  // 72: pb.GameFinished.game_result_status:type_name -> pb.GameResultStatus
	6,  // 73: pb.GameFinished.game_state:type_name -> pb.GameState
	54, // 74: pb.PlayerLeft.left_at:type_name -> google.protobuf.Timestamp
	54, // 75: pb.PlayerRejoined.rejoined_at:type_name -> google.protobuf.Timestamp
	33, // 76: pb.GameInfo.PendingDrawOffersEntry.value:type_name -> pb.DrawOffer
...
func file_proto_juicer_juicer_proto_init() {
	...
	file_proto_juicer_juicer_proto_msgTypes[30].OneofWrappers = []any{}
	file_proto_juicer_juicer_proto_msgTypes[34].OneofWrappers = []any{}
	type x struct{}
