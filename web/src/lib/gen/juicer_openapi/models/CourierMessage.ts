...
export interface CourierMessage {
     ...
     * @memberof CourierMessage
     */
    templateType: CourierMessageTemplateTypeEnum;
    /**
     * 
 ...
 * @export
 */
export const CourierMessageTemplateTypeEnum = {
...
export type CourierMessageTemplateTypeEnum = typeof CourierMessageTemplateTypeEnum[keyof typeof CourierMessageTemplateTypeEnum];


/**
 * Check if a given object implements the CourierMessage interface.
 */
export function instanceOfCourierMessage(value: object): value is CourierMessage {
...
export function CourierMessageFromJSON(json: any): CourierMessage {
    return CourierMessageFromJSONTyped(json, false);
}

export function CourierMessageFromJSONTyped(json: any, ignoreDiscriminator: boolean): CourierMessage {
    if (json == null) {
        return json;
    }
    return {
...
export function CourierMessageToJSON(json: any): CourierMessage {
    return CourierMessageToJSONTyped(json, false);
}

export function CourierMessageToJSONTyped(value?: CourierMessage | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
