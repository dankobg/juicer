...
<script lang="ts">
	...
	import { customerDashboardNavItems, developerDashboardNavItems } from './nav-items';
	...
	let {
		...
		isDeveloper,
		...restProps
	}: ComponentProps<typeof Sidebar.Root> & { logoutUrl?: string; user: User | null; isDeveloper?: boolean } = $props();
