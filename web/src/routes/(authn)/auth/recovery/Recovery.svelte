<script lang="ts">
	...
	import ForgotPasswordHeader from 'flowbite-svelte-blocks/ForgotPasswordHeader.svelte';
	import ForgotPassword from 'flowbite-svelte-blocks/ForgotPassword.svelte';
			...
			if (url) {
				try {
					...
					if (axiosErr.response?.status === 400) {
						const axiosErr = error as AxiosError<RecoveryFlow>;
