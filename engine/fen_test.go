...
func TestValidateFen(t *testing.T) {
	testCases := map[string]struct {
		...
		"invalid delim length":           {fen: " rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w  KQkq - 0 1 ", wantErr: true},
		"invalid active turn W":          {fen: "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR W KQkq - 0 1", wantErr: true},
		"invalid active turn B":          {fen: "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR B KQkq - 0 1", wantErr: true},
		"invalid active turn -":          {fen: "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR - KQkq - 0 1", wantErr: true},
		"invalid half move clock":        {fen: "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - -1 1", wantErr: true},
		"invalid full move clock 0":      {fen: "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 0", wantErr: true},
		"invalid enp square":             {fen: "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq k3 0 1", wantErr: true},
		"invalid castle junk":            {fen: "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w zz - 0 1", wantErr: true},
		"invalid castle order QKqk":      {fen: "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w QKqk - 0 1", wantErr: true},
		"invalid castle order QKq":       {fen: "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w QKq - 0 1", wantErr: true},
		"invalid castle order QKk":       {fen: "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w QKk - 0 1", wantErr: true},
		"invalid castle order Qqk":       {fen: "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w Qqk - 0 1", wantErr: true},
		"invalid castle order Kqk":       {fen: "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w Kqk - 0 1", wantErr: true},
		"invalid castle order qk":        {fen: "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w qk - 0 1", wantErr: true},
		"invalid castle order QK":        {fen: "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w QK - 0 1", wantErr: true},
		"invalid missing white king":     {fen: "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQ1BNR w kq - 0 1", wantErr: true},
		"invalid missing black king":     {fen: "rnbq1bnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQ - 0 1", wantErr: true},
		"invalid two white kings":        {fen: "rnbqkbnr/pppppppp/8/8/8/4K3/PPPPPPPP/RNBQKBNR w KQkq - 0 1", wantErr: true},
		"invalid two white black":        {fen: "rnbqkbnr/pppppppp/4k3/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1", wantErr: true},
		"invalid white pawn on 8th rank": {fen: "rnbqkbnP/ppppppp1/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1", wantErr: true},
		"invalid black pawn on 1st rank": {fen: "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPP1/RNBQKBNp w KQkq - 0 1", wantErr: true},
	}
