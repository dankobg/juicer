...
create table "game" (
  ...
  "white_game_remaining_secs" integer not null,
  "white_game_remaining_ns" bigint not null,
  "black_game_remaining_secs" integer not null,
  "black_game_remaining_ns" bigint not null,
