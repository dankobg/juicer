					...
					<Table.Root>
						...
						<Table.Body>
							<Table.Row>
								...
								<Table.Cell class="md:table.-cell xl:table.-column hidden lg:hidden">2023-06-23</Table.Cell>
							...
							<Table.Row>
								...
								<Table.Cell class="md:table.-cell xl:table.-column hidden lg:hidden">2023-06-24</Table.Cell>
							...
							<Table.Row>
								...
								<Table.Cell class="md:table.-cell xl:table.-column hidden lg:hidden">2023-06-25</Table.Cell>
							...
							<Table.Row>
								...
								<Table.Cell class="md:table.-cell xl:table.-column hidden lg:hidden">2023-06-26</Table.Cell>
							...
							<Table.Row>
								...
								<Table.Cell class="md:table.-cell xl:table.-column hidden lg:hidden">2023-06-27</Table.Cell>
				...
				<Card.Content class="grid gap-8">
					<div class="flex items-center gap-4">
						<Avatar.Root class="hidden h-9 w-9 sm:flex">
							<Avatar.Image src="/images/logo.svg" alt="Avatar" />
